namespace Partio.Core.Database.Sqlserver.Implementations
{
    ...
    /// <summary>
    /// SQL Server implementation of embedding endpoint database operations.
    /// </summary>
    public class EmbeddingEndpointMethods : IEmbeddingEndpointMethods
    {
        ...
        public EmbeddingEndpointMethods(SqlServerDatabaseDriver driver, LoggingModule logging)
        {
        ...
        public async Task<EmbeddingEndpoint> CreateAsync(EmbeddingEndpoint endpoint, CancellationToken token = default)
        {
            ...
            string query =
                ...
                "health_check_enabled, health_check_url, health_check_method, health_check_interval_ms, health_check_timeout_ms, maximum_timeout_ms, max_concurrent_requests, max_queue_depth, context_size, " +
                ...
                endpoint.MaxQueueDepth + ", " +
                endpoint.ContextSize + ", " +
        ...
        public async Task<EmbeddingEndpoint?> ReadByIdAsync(string id, CancellationToken token = default)
        {
            ...
            string query = "SELECT TOP 1 * FROM embedding_endpoints WHERE id = '" + _Driver.Sanitize(id) + "';";
        ...
        public async Task<EmbeddingEndpoint?> ReadByModelAsync(string tenantId, string model, CancellationToken token = default)
        {
            ...
            string query = "SELECT TOP 1 * FROM embedding_endpoints WHERE tenant_id = '" + _Driver.Sanitize(tenantId) + "' AND model = '" + _Driver.Sanitize(model) + "';";
            DataTable result = await _Driver.ExecuteQueryAsync(query, false, token).ConfigureAwait(false);
        ...
        public async Task<EmbeddingEndpoint> UpdateAsync(EmbeddingEndpoint endpoint, CancellationToken token = default)
        {
            ...
            string query =
                ...
                "max_queue_depth = " + endpoint.MaxQueueDepth + ", " +
                "context_size = " + endpoint.ContextSize + ", " +
        ...
        public async Task<EnumerationResult<EmbeddingEndpoint>> EnumerateAsync(string tenantId, EnumerationRequest request, CancellationToken token = default)
        {
            ...
            string dataQuery = "SELECT TOP " + fetchCount + " * FROM embedding_endpoints " + whereClause + " " + orderByClause + ";";
