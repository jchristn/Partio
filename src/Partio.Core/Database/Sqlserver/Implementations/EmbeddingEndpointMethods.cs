    ...
    public class EmbeddingEndpointMethods : IEmbeddingEndpointMethods
    {
        ...
        public async Task<EmbeddingEndpoint> CreateAsync(EmbeddingEndpoint endpoint, CancellationToken token = default)
        {
            ...
            string query =
                ...
                "health_check_enabled, health_check_url, health_check_method, health_check_interval_ms, health_check_timeout_ms, maximum_timeout_ms, max_concurrent_requests, max_queue_depth, " +
