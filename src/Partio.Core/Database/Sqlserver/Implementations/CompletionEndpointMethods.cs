namespace Partio.Core.Database.Sqlserver.Implementations
{
    ...
    /// <summary>
    /// SQL Server implementation of completion endpoint database operations.
    /// </summary>
    public class CompletionEndpointMethods : ICompletionEndpointMethods
    {
        ...
        public CompletionEndpointMethods(SqlServerDatabaseDriver driver, LoggingModule logging)
        {
        ...
        public async Task<CompletionEndpoint?> ReadByIdAsync(string id, CancellationToken token = default)
        {
            ...
            string query = "SELECT TOP 1 * FROM completion_endpoints WHERE id = '" + _Driver.Sanitize(id) + "';";
        ...
        public async Task<EnumerationResult<CompletionEndpoint>> EnumerateAsync(string tenantId, EnumerationRequest request, CancellationToken token = default)
        {
            ...
            string dataQuery = "SELECT TOP " + fetchCount + " * FROM completion_endpoints " + whereClause + " " + orderByClause + ";";
