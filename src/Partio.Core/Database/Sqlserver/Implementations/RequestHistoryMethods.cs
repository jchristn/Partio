namespace Partio.Core.Database.Sqlserver.Implementations
{
    ...
    public class RequestHistoryMethods : IRequestHistoryMethods
    {
        ...
        public RequestHistoryMethods(SqlServerDatabaseDriver driver, LoggingModule logging)
        {
        ...
        public async Task<RequestHistoryEntry?> ReadByIdAsync(string id, CancellationToken token = default)
        {
            ...
            string query = "SELECT TOP 1 * FROM request_history WHERE id = '" + _Driver.Sanitize(id) + "';";
        ...
        public async Task<EnumerationResult<RequestHistoryEntry>> EnumerateAsync(string tenantId, EnumerationRequest request, CancellationToken token = default)
        {
            ...
            string dataQuery = "SELECT TOP " + fetchCount + " * FROM request_history " + whereClause + " " + orderByClause + ";";
