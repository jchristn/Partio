namespace Partio.Core.Database.Postgresql.Implementations
{
    ...
    /// <summary>
    /// PostgreSQL implementation of embedding endpoint database operations.
    /// </summary>
    public class EmbeddingEndpointMethods : IEmbeddingEndpointMethods
    {
        ...
        public EmbeddingEndpointMethods(PostgresqlDatabaseDriver driver, LoggingModule logging)
        {
