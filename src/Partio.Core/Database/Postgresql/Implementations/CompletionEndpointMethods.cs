namespace Partio.Core.Database.Postgresql.Implementations
{
    ...
    /// <summary>
    /// PostgreSQL implementation of completion endpoint database operations.
    /// </summary>
    public class CompletionEndpointMethods : ICompletionEndpointMethods
    {
        ...
        /// </summary>
        public CompletionEndpointMethods(PostgresqlDatabaseDriver driver, LoggingModule logging)
        {
