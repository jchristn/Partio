namespace Partio.Core.Database.Sqlite.Queries
{
    /// <summary>
    /// Contains CREATE TABLE IF NOT EXISTS statements for initializing the SQLite database schema.
    /// </summary>
    public static class SetupQueries
    {
        ...
        public static readonly string AlterEmbeddingEndpointsAddName =
            @"ALTER TABLE embedding_endpoints ADD COLUMN name VARCHAR(256) NULL;";
        ...
        public static readonly string AlterEmbeddingEndpointsAddTokenizationJson =
            @"ALTER TABLE embedding_endpoints ADD COLUMN tokenization_json TEXT NULL;";
        ...
        public static readonly string AlterEmbeddingEndpointsAddLabelsJson =
            @"ALTER TABLE embedding_endpoints ADD COLUMN labels_json TEXT NULL;";
        ...
        public static readonly string AlterEmbeddingEndpointsAddTagsJson =
            @"ALTER TABLE embedding_endpoints ADD COLUMN tags_json TEXT NULL;";
        ...
        public static readonly string AlterEmbeddingEndpointsAddMaximumTimeoutMs =
            @"ALTER TABLE embedding_endpoints ADD COLUMN maximum_timeout_ms INTEGER NOT NULL DEFAULT 60000;";
        ...
        public static readonly string AlterEmbeddingEndpointsAddMaxConcurrentRequests =
            @"ALTER TABLE embedding_endpoints ADD COLUMN max_concurrent_requests INTEGER NOT NULL DEFAULT 2;";
        ...
        public static readonly string AlterEmbeddingEndpointsAddMaxQueueDepth =
            @"ALTER TABLE embedding_endpoints ADD COLUMN max_queue_depth INTEGER NOT NULL DEFAULT 0;";
        ...
        public static readonly string AlterEmbeddingEndpointsAddContextSize =
            @"ALTER TABLE embedding_endpoints ADD COLUMN context_size INTEGER NOT NULL DEFAULT 0;";
        ...
        public static readonly string AlterCompletionEndpointsAddMaximumTimeoutMs =
            @"ALTER TABLE completion_endpoints ADD COLUMN maximum_timeout_ms INTEGER NOT NULL DEFAULT 60000;";
        ...
        public static readonly string AlterCompletionEndpointsAddMaxConcurrentRequests =
            @"ALTER TABLE completion_endpoints ADD COLUMN max_concurrent_requests INTEGER NOT NULL DEFAULT 2;";
        ...
        public static readonly string AlterCompletionEndpointsAddMaxQueueDepth =
            @"ALTER TABLE completion_endpoints ADD COLUMN max_queue_depth INTEGER NOT NULL DEFAULT 0;";
        ...
        public static readonly string AlterCompletionEndpointsAddContextSize =
            @"ALTER TABLE completion_endpoints ADD COLUMN context_size INTEGER NOT NULL DEFAULT 0;";
        ...
        public static readonly string AlterCompletionEndpointsAddLabelsJson =
            @"ALTER TABLE completion_endpoints ADD COLUMN labels_json TEXT NULL;";
        ...
        public static readonly string AlterCompletionEndpointsAddTagsJson =
            @"ALTER TABLE completion_endpoints ADD COLUMN tags_json TEXT NULL;";
