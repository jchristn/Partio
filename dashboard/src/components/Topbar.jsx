  ...
  return (
    <header className="topbar">
      ...
      <div className="topbar-right">
        <a href="https://discord.gg/tRAN8HgvK5" target="_blank" rel="noopener noreferrer" className="github-link" title="Discord">
        ...
        <a href="https://github.com/jchristn/partio" target="_blank" rel="noopener noreferrer" className="github-link" title="GitHub">
          <svg width="20" height="20" viewBox="0 0 16 16" fill="currentColor">
